...
public partial class DbAdvetureWorksContext : DbContext
{
    public DbAdvetureWorksContext()
    {
    }

    public DbAdvetureWorksContext(DbContextOptions<DbAdvetureWorksContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.SystemInformationId).HasName("PK__BuildVer__35E58ECA1A5F7368");
